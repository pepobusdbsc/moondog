...
// 埋点
export const buriedPoint = async(address,type) => {
  try {
    const response = await fetch(`${process.env.REACT_APP_FETCH_API}/api/buryingPoint`, {
      method: 'POST',
      headers: {
    ...
    console.error('Unable to fetch point:', error)
  }
}
