...
import { BLOCKS_PER_YEAR, CAKE_PER_BLOCK, BLOCKS_PER_QUARTER } from 'config'
...
export const getFarmApr = (poolWeight: BigNumber, cakePriceUsd: BigNumber, poolLiquidityUsd: BigNumber): number => {
  // console.log('poolWeight: ', poolWeight, 'cakePriceUsd: ', cakePriceUsd.toJSON(), 'poolLiquidityUsd: ', poolLiquidityUsd.toJSON())
