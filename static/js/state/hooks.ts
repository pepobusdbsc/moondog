...
import { Toast, toastTypes } from 'moondoge-uikit'
...
export const usePriceCakeBusd = (): BigNumber => {
  ...
  // console.log(bnbBusdPrice.toJSON(), cakeBusdPrice.toJSON())
  // console.log(bnbBusdFarm)
  // console.log(new BigNumber(1).div(bnbBusdFarm.tokenPriceVsQuote))
  const bnbPrice = localStorage.getItem("bnbPrice")
  const bnbPriceOld = localStorage.getItem("bnbPriceOld")

  const { priceUSD } = useTokenData("0xf9f89ef3c1b96a662db5fc9184dbf6ca1416dfe5",bnbPrice,bnbPriceOld)
  // console.log(bnbBusdPrice,'bnbBusdPrice====')
 return new BigNumber(priceUSD)
  // return cakeBusdPrice
}

export const useValuePriceBusd = (): BigNumber => {
  const bnbPrice = localStorage.getItem("bnbPrice")
  const bnbPriceOld = localStorage.getItem("bnbPriceOld")

  const { priceUSD } = useTokenData("0xc64def48a8a588020469cdd7a227f551129cdcb0",bnbPrice,bnbPriceOld)
 return new BigNumber(priceUSD)
}
